...
badd +47 infrastructure/litellm_client.py
badd +56 domain/services/scraper.py
badd +0 term://~/Repos/newspipe/src//89645:/usr/bin/fish
badd +27 ~/Repos/newspipe/pyproject.toml
badd +70 control/main.py
badd +1 ~/Repos/infra-stuff/nvim/lua/core/keymaps.lua
badd +1 ~/Repos/cs
badd +14 ~/Repos/newspipe/input_files/relevance_policies.json
badd +13 ../input_files/traversal_policies.json
badd +192 control/dependency_layers.py
...
normal! 0
tabnext
edit control/dependency_layers.py
argglobal
balt application/services/data_ingestion.py
setlocal foldmethod=manual
setlocal foldexpr=0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 192 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 192
normal! 022|
tabnext
edit infrastructure/litellm_client.py
argglobal
balt application/services/data_ingestion.py
setlocal foldmethod=manual
setlocal foldexpr=0
...
normal! 0
tabnext
edit domain/services/scraper.py
argglobal
balt infrastructure/litellm_client.py
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
setlocal foldignore=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((12 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
...
silent! normal! zE
let &fdl = &fdl
let s:l = 70 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 70
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 87 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 87
