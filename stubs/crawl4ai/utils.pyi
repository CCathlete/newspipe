...
def perform_completion_with_backoff(provider, prompt_with_variables, api_token, json_response=..., base_url=..., base_delay=..., max_attempts=..., exponential_factor=..., **kwargs): # -> ModelResponse | CustomStreamWrapper | list[dict[str, Any]] | None:
    """
...
async def aperform_completion_with_backoff(provider, prompt_with_variables, api_token, json_response=..., base_url=..., base_delay=..., max_attempts=..., exponential_factor=..., **kwargs): # -> ModelResponse | CustomStreamWrapper | list[dict[str, Any]] | None:
    """
