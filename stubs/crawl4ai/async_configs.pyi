...
def to_serializable_dict(obj: Any, ignore_default_value: bool = ...): # -> str | int | float | bool | dict[str, Any] | Any | list[str | int | float | bool | dict[str, Any] | Any | list[Any] | list[str | int | float | bool | dict[str, Any] | Any | list[Any] | None] | None] | list[str | int | float | bool | dict[str, Any] | Any | list[Any] | None] | None:
    """
...
class LLMConfig:
    def __init__(self, provider: str = ..., api_token: Optional[str] = ..., base_url: Optional[str] = ..., temperature: Optional[float] = ..., max_tokens: Optional[int] = ..., top_p: Optional[float] = ..., frequency_penalty: Optional[float] = ..., presence_penalty: Optional[float] = ..., stop: Optional[List[str]] = ..., n: Optional[int] = ..., backoff_base_delay: Optional[int] = ..., backoff_max_attempts: Optional[int] = ..., backoff_exponential_factor: Optional[int] = ...) -> None:
