...
def to_serializable_dict(obj: Any, ignore_default_value: bool = ...): # -> str | int | float | bool | dict[str, Any] | Any | list[str | int | float | bool | dict[str, Any] | Any | list[Any] | list[str | int | float | bool | dict[str, Any] | Any | list[Any] | None] | None] | None:
    """
